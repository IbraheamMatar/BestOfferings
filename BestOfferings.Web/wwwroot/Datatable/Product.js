            ...
            },
            {
                ...
                },
                {
                    ...
                    template: function (data) {
                        return '\<a  href ="/Product/Update/'+ data.id + '" class="PopUp btn btn-sm btn-clean btn-icon mr-2" title="تعديل  بيانات ' + data.name + ' ">\
                        ...
                        <a href ="/Product/Delete/' + data.id + '" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="Delete">\
